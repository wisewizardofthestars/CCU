...
function RegisterConsumer({ onLoginClick, onBack }) {
  ...
  const handleRegister = () => {
    ...
    console.log("Registering user:", formData, "as", userType);
  };
    ...
    <div className="relative w-[360px] h-[640px] mx-auto bg-white">
      ...
      <div className="absolute left-0 top-0 w-full h-[37px] bg-white border-b border-[#D9D9D9] flex items-center justify-between px-2">
        ...
        <div className="flex items-center justify-center w-[58px] h-[15px] ml-[6px] mt-[8px]">
          <span className="text-black text-center text-[16px] font-normal tracking-[-0.24px]" style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}>
            16:20
          </span>
        </div>
      ...
      <div className="absolute left-[5px] top-[71px] w-[350px] h-[80px]">
        <h1 
          ...
          style={{ fontFamily: 'Outfit, -apple-system, Roboto, Helvetica, sans-serif' }}
        >
          ChainPlate
        </h1>
      </div>
      ...
      <div className="absolute left-[67px] top-[170px] w-[214px] h-[32px]">
        ...
        <button
          ...
          className={`absolute left-0 top-0 w-[108px] h-[32px] rounded-l-[10px] border-2 ${
            userType === "consumer" ? "border-[#45ADA1] bg-[#45ADA1]" : "border-[#D9D9D9] bg-white"
          } flex items-center justify-center transition`}
        >
          <span
            className={`text-[18px] font-normal tracking-[-0.24px] ${
              userType === "consumer" ? "text-white" : "text-black"
            }`}
        ...
        <button
          ...
          className={`absolute left-[98px] top-0 w-[116px] h-[32px] rounded-r-[10px] border-2 ${
            userType === "producer" ? "border-[#45ADA1] bg-[#45ADA1]" : "border-[#D9D9D9] bg-white"
          } flex items-center justify-center transition`}
        >
          <span
            className={`text-[18px] font-normal tracking-[-0.24px] ${
              userType === "producer" ? "text-white" : "text-black"
            }`}
            style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
          >
            Producer
      ...
      <div className="absolute left-[20px] top-[226px] w-[298px] h-[64px]">
        <label 
          className="absolute left-0 top-0 w-[94px] h-[13px] text-black text-[12px] font-medium tracking-[-0.24px]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        >
          Username
        </label>
        <input
          ...
          className="absolute left-[22px] top-[21px] w-[276px] h-[43px] rounded-[10px] bg-[#E8E8E8] px-[8px] text-black text-[16px] font-medium tracking-[-0.24px] placeholder:text-[#8E8383] placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-[#45ADA1]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        />
      </div>
      ...
      <div className="absolute left-[10px] top-[301px] w-[307px] h-[61px]">
        ...
        <input
          ...
          className="absolute left-[31px] top-[18px] w-[276px] h-[43px] rounded-[10px] bg-[#E8E8E8] px-[8px] text-black text-[16px] font-medium tracking-[-0.24px] placeholder:text-[#8E8383] placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-[#45ADA1]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        />
      </div>
      ...
      <div className="absolute left-[19px] top-[377px] w-[298px] h-[61px]">
        ...
        <input
          ...
          className="absolute left-[22px] top-[18px] w-[276px] h-[43px] rounded-[10px] bg-[#E8E8E8] px-[8px] text-black text-[16px] font-medium tracking-[-0.24px] placeholder:text-[#8E8383] placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-[#45ADA1]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        />
      </div>
      ...
      <div className="absolute left-[23px] top-[454px] w-[295px] h-[61px]">
        <label 
          className="absolute left-0 top-0 w-[133px] h-[13px] text-black text-[12px] font-medium tracking-[-0.24px]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        >
          Confirm password
        </label>
        <input
          ...
          onChange={handleInputChange}
          placeholder=""
          className="absolute left-[19px] top-[18px] w-[276px] h-[43px] rounded-[10px] bg-[#E8E8E8] px-[8px] text-black text-[16px] font-medium tracking-[-0.24px] placeholder:text-[#8E8383] placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-[#45ADA1]"
          style={{ fontFamily: 'Roboto, -apple-system, Helvetica, sans-serif' }}
        />
      </div>
      ...
      <div className="absolute left-[105px] top-[536px] w-[150px] h-[36px]">
        <button 
          ...
          className="w-full h-full rounded-[10px] border-[0.6px] border-[rgba(69,173,161,0.45)] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] flex items-center justify-center transition hover:opacity-90" 
      ...
      <div className="absolute left-[103px] top-[584px] w-[150px] h-[34px] flex items-center justify-center">
        <button
          onClick={onLoginClick}
          className="text-black text-center text-[11px] font-medium hover:underline transition"
          style={{ fontFamily: 'Outfit, -apple-system, Roboto, Helvetica, sans-serif', fontWeight: 500 }}
        >
          Already have an account? Login here!
        </button>
