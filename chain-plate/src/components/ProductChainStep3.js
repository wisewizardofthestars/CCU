...
function ProductChainStep3({ onBack, onPrevious }) {
  return (
    <div className="w-full max-w-[360px] mx-auto h-screen bg-gradient-to-b from-[#C5F1ED] to-white relative flex flex-col font-outfit overflow-hidden">
      {/* Status Bar */}
      ...
      {/* Top Bar */}
      <div className="w-full h-[50px] bg-[#45ADA1] flex items-center justify-center relative flex-shrink-0">
        <button
          onClick={onBack}
      ...
      <div className="flex-1 relative overflow-hidden">
        {/* Navigation Arrow - Left Only */}
        <button
          onClick={onPrevious}
          className="absolute left-[29px] top-[39px] z-10 opacity-60 hover:opacity-100 transition-opacity"
        >
          <svg width="35" height="35" viewBox="0 0 35 35" fill="none">
            <path
              d="M20 10L13 17.5L20 25"
              stroke="#888"
              strokeWidth="3"
              strokeLinecap="round"
        ...
        {/* Progress Dots */}
        <div className="absolute left-1/2 -translate-x-1/2 top-[50px] flex items-center gap-[26px] z-10">
          <div className="w-[8px] h-[8px] rounded-full bg-[#D9D9D9]" />
          <div className="w-[8px] h-[8px] rounded-full bg-[#D9D9D9]" />
          <div className="w-[8px] h-[8px] rounded-full bg-[#45ADA1]" />
        </div>

        {/* Retail Card */}
        <div className="absolute left-[24px] top-[127px] w-[295px] h-[70px] border-2 border-black flex items-center px-4 gap-3 z-10">
          {/* Truck Icon */}
          <div className="w-[60px] h-[50px] flex items-center justify-center flex-shrink-0">
            <img
              src="https://api.builder.io/api/v1/image/assets/TEMP/d186ea4ae833692ebb6252b32d47ad88872fb526?width=134"
              alt="Truck"
              className="w-full h-full object-contain"
            />
          </div>
          <div className="flex-1 flex flex-col justify-center">
            <div className="font-outfit text-[24px] font-semibold text-black tracking-[-0.24px] leading-tight">
              Retail
            </div>
        ...
        {/* Vertical Line from Retail Card */}
        <div
          className="absolute left-[125px] top-[197px] w-[2px] bg-black"
          style={{ height: "335px", zIndex: 5 }}
        />

        {/* Supermarket Scene at Bottom */}
        <div
          className="absolute bottom-0 left-0 right-0 h-[380px]"
          style={{ zIndex: 1 }}
        >
          {/* Supermarket Shelves - Main background */}
          <img
            src={require("./images/step3/image2.png")}
            alt="Supermarket Shelves"
            className="absolute left-[80px] bottom-[80px] w-[450px] h-[280px] object-contain"
            style={{ zIndex: 2 }}
          />

          {/* Left Blueberry Character - on shelf */}
          <img
            src={require("./images/step3/image.png")}
            alt="Blueberry Character"
            className="absolute left-[200px] bottom-[185px] w-[70px] h-[65px] object-contain"
            style={{ zIndex: 3 }}
          />

          {/* Right Blueberry Character - on shelf */}
          <img
            src={require("./images/step3/image.png")}
            alt="Blueberry Character"
            className="absolute left-[260px] bottom-[185px] w-[70px] h-[65px] object-contain"
            style={{ zIndex: 3 }}
          />

          {/* Store Background decoration */}
          <img
            src={require("./images/step3/image1.png")}
            alt="Store Background"
            className="absolute left-0 bottom-0 w-[360px] h-[120px] object-cover"
            style={{ zIndex: 1 }}
          />
        </div>
      </div>
...
export default ProductChainStep3;
