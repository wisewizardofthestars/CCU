  ...
  return (
    <div className="w-full max-w-[360px] mx-auto h-screen bg-white relative flex flex-col font-['Outfit']">
      ...
      <div className="relative w-full h-[60px] bg-gradient-to-r from-[#45ADA1] to-[#3d9a8f] flex items-center px-4 flex-shrink-0">
        ...
        <h1 className="text-white text-[20px] font-bold">My Products</h1>
      </div>
      ...
      <div className="flex gap-2 px-4 py-4">
        <button
          ...
          className={`flex-1 h-[44px] rounded-[22px] font-semibold text-[15px] transition ${
            activeTab === "current"
              ? "bg-[#45ADA1] text-white shadow-md"
              : "bg-[#E8F5F3] text-[#45ADA1]"
          }`}
        >
          Current crops
        </button>
          ...
          products.length > 0 ? (
            <div className="grid grid-cols-2 gap-4">
              {products.map((product) => (
                <div
                  key={product.id}
                  className="bg-white rounded-[15px] shadow-md overflow-hidden hover:shadow-lg transition"
                >
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-[16px] font-bold text-[#45ADA1] mb-2">
                      {product.price}
                    </p>
            ...
            <div className="flex flex-col items-center justify-center py-16">
              <div className="w-[100px] h-[100px] bg-gray-100 rounded-full flex items-center justify-center mb-4">
              ...
              <p className="text-gray-500 text-[16px] text-center mb-2">
                No products yet
              </p>
      ...
      <button
        ...
        className="fixed bottom-[90px] right-6 w-[56px] h-[56px] bg-[#45ADA1] rounded-full shadow-lg hover:bg-[#3d9a8f] transition flex items-center justify-center z-30"
      >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[70px] bg-white border-t border-gray-200 flex items-center justify-around px-4 z-20">
        {/* Dashboard */}
        <button
          onClick={onBack}
