...
function PointsPage({
  ...
  return (
    <div className="w-full max-w-[360px] mx-auto h-screen bg-white relative flex flex-col overflow-hidden">
      ...
      <div className="w-full h-[60px] bg-white flex items-center justify-between px-4 border-b border-[#D9D9D9] flex-shrink-0 relative z-20">
        <button
          onClick={onBack}
      ...
      <div className="flex-1 relative z-10 flex flex-col items-center pt-12">
        ...
        {/* Points Display */}
        <div
          className="text-[#FFD559] text-center font-outfit text-[64px] font-bold tracking-[-0.24px] leading-none mt-2"
        ...
        <div className="absolute bottom-[100px] left-0 right-0 px-[42px] flex justify-between gap-6">
          {/* Spend Card */}
          <div
            onClick={onNavigateToSpend}
            className="relative w-[120px] h-[120px] rounded-[10px] overflow-hidden shadow-lg cursor-pointer hover:scale-105 transition-transform bg-[#45ADA1]"
          >
            <img
          ...
          {/* Collection Card */}
          <div className="relative w-[120px] h-[120px] rounded-[10px] overflow-hidden shadow-lg cursor-pointer hover:scale-105 transition-transform bg-[#45ADA1]">
            <div onClick={onNavigateToCollection}
