...
function ProductChainStep2({ onBack, onNext, onPrevious, product }) {
  return (
    <div className="w-full max-w-[360px] mx-auto h-screen bg-gradient-to-b from-[#C5F1ED] to-white relative flex flex-col font-outfit overflow-hidden">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <button
          onClick={onNext}
          className="absolute right-[29px] top-[39px] z-10 opacity-60 hover:opacity-100 transition-opacity"
        >
          <svg width="35" height="35" viewBox="0 0 35 35" fill="none">
            <path
              d="M15 10L22 17.5L15 25"
              stroke="#888"
              strokeWidth="3"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        {/* Vertical Line from Transport Card */}
        <div
          className="absolute left-[165px] top-[197px] w-[2px] bg-black"
          style={{ height: "210px", zIndex: 5 }}
        />

        {/* Road and Truck Scene at Bottom - Using Local Images */}
        <div
          className="absolute bottom-0 left-0 right-0 h-[450px]"
          style={{ zIndex: 1 }}
        >
          <img
            src={require("./images/step2/image2.png")}
            alt="Truck scene"
            className="absolute bottom-0 left-0 w-full h-[82px] object-cover"
            style={{ zIndex: 1 }}
          />

          {/* Complete Scene with Truck and Road */}
          <img
            src={require("./images/step2/image1.png")}
            alt="Truck scene"
            className="absolute bottom-0 left-0 w-[360px] h-[360px] object-cover"
            style={{ zIndex: 1 }}
          />

          {/* Blueberry Character in Truck Window */}
          <img
            src={require("./images/step2/image.png")}
            alt="Blueberry character"
            className="absolute right-[50px] bottom-[135px] w-[55px] h-[50px]"
            style={{ zIndex: 20 }}
          />
        </div>
      </div>
...
export default ProductChainStep2;
