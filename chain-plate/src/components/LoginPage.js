...
const LoginPage = ({ onLogin }) => {
  ...
  return (
    <div className="relative w-[360px] h-[640px] mx-auto bg-white">
      ...
      {/* ChainPlate Title */}
      <div className="absolute left-[5px] top-[212px] w-[350px] h-[80px]">
        <h1
      ...
      <div className="absolute left-[105px] top-[374px] w-[150px] h-[35px]">
        ...
        >
          <span
            className="text-white text-[20px] leading-normal"
            style={{
              fontFamily:
      ...
      {/* Register Button */}
      <div className="absolute left-[105px] top-[450px] w-[150px] h-[36px]">
        <button
