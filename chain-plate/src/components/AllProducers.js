      ...
      <div className="w-full h-[60px] shadow-[0_2px_8px_rgba(69,173,161,0.15)] flex items-center px-4 bg-white flex-shrink-0 z-20">
        ...
        <div>
          ...
          <p className="text-gray-400 font-['Outfit'] text-[12px]">
            {producers.length} producers nearby
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        <div className="grid grid-cols-2 gap-4">
          {producers.map((producer) => (
            <div
              key={producer.id}
              className="group cursor-pointer bg-white rounded-2xl shadow-md hover:shadow-xl transition-all p-4 flex flex-col items-center"
            >
              <div className="w-[80px] h-[80px] rounded-full overflow-hidden shadow-md mb-3 group-hover:scale-105 transition-transform">
                <img
                  src={producer.image}
                  alt={producer.name}
              ...
              <div className="text-center">
                <span className="text-black font-['Outfit'] text-[16px] font-semibold leading-tight block">
                  {producer.name}
                </span>
                <span className="text-gray-600 font-['Outfit'] text-[14px] leading-tight block mb-2">
                  {producer.subtitle}
                </span>
                <span className="text-gray-400 font-['Outfit'] text-[11px] flex items-center gap-1 justify-center">
